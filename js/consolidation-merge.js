...
function add_results_Level1(o) {
	...
	if(level1Result.includes("Yes") && level==1){
		...
		document.getElementById("redirect1").innerHTML = "As one or more of the pages involved are acquired we cannot merge/consolidate. If the acquisition was over 5 years ago we can offer a follower migration, however each employee will have to move their employment to the new company page themself.";
